...
methods -> init:tearDown:advance:energy:offset_momentum:benchmark:getExpectedResult:test:setup:benchmark:setup:test:getExpectedResult:sqrt:range
"""

from polyglot import import_value
from math import sqrt
benchmarkName = "n-body_struct"
